...
const inputSchema = z.object({
  ...
  challengeResources: z
    .array(z.string())
    .default([])
    .describe("Runtime-only paths to authorized challenge resources; provider files are not tracked in this repository."),
    ...
    <Workflow name="challenge3-target-scout">
      <Sequence>
        <DefineIcp
          ...
          challengeResources={ctx.input.challengeResources}
        />
