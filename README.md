...
| Submission evidence | Decks, transcript, proof pack, screenshots, and validators | `deliverables/challenge3-target-customer-scouting/` |
...
zurich-scout-goodboys/
  ...
  deliverables/
    challenge3-target-customer-scouting/
      ...
      prototype-evidence/                      # Portable validator; outputs stay private
...
Zürich-provided documents, AMA notes, seed-company datasets, and generated
account-level research outputs are intentionally not published. Authorized
resources can be supplied at runtime through `challengeResources`, and seed
companies through `seedCompanies`.
